...
<Card href="/cloud/overview" title="Managed Cloud" icon="cloud">
  Flipt Managed Cloud is a fully managed feature management platform that enables you to continue to use Flipt's feature management capabilities with zero maintenance. Own your feature data, while still benefiting from our cloud-based management console.
</Card>
