...
At Flipt, we're pioneering the next generation of feature flag management with a new innovative offering: [Flipt Hybrid Cloud](/managed/hybrid).
...
If you're interested in piloting the Flipt Hybrid Cloud solution and contributing to it's development risk-free, we'd love to hear from you.
