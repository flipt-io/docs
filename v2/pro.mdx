...
<Snippet file="v2-pro.mdx" />

## Why Teams Choose Flipt Pro

Enterprise-grade security, workflows, and support
for teams that need more than basic feature flags.
...
- **Encrypted Storage**: All secrets stored with industry-standard encryption
...
- **Volume Discounts**: Special pricing for large deployments
...
Contact us at [enterprise@flipt.io](mailto:enterprise@flipt.io) to discuss your requirements.
