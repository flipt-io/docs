...
This document will walk you through creating your first feature flag in Flipt v2.

## Setup

Before getting started, make sure the Flipt server is up and running on your
host on your chosen ports. See [Installation](/v2/installation) for more.
...
helm install flipt flipt/flipt/v2
```

```console Homebrew
brew install flipt-io/brew/flipt@v2
```
...
// TODO: add screenshot of environments/namespace picker
...
!["Create Flag"](/v1/images/getting_started/create_flag.png)
...
!["Create Variant"](/v1/images/getting_started/create_variant.png)
...
!["Create Segment"](/v1/images/getting_started/create_segment.png)
...
!["Create Constraint"](/v1/images/getting_started/create_constraint.png)
...
!["Create"](/v1/images/getting_started/create_rule.png)
...
[Concepts](/v1/concepts#evaluation) documentation.
...
!["Evaluation Console"](/v1/images/getting_started/evaluation_console.png)
