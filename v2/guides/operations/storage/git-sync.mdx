...
Notice in the top right of the Flipt UI you will see a new GitHub icon and a link to the GitHub repository.

Clicking this will take you to the GitHub repository where you can view the flag state.

![Flipt GitHub Sync](/v2/images/guides/operations/storage/github_linked.png)
