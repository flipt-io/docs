...
flipt:
  config:
    ...
    storage:
      default:
        remote: "https://github.com/your-org/your-flags-repo.git"
        branch: "main"
        poll_interval: "30s"
        backend:
          type: local
...
- Log level to 'INFO'
- Git remote sync with a specific repository and branch
- Local storage backend with periodic sync from remote repository
...
- **Monitor changes**: Stream state updates to our [Client SDKs](/v2/integration/client)
