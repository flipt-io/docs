...
![Constraint Types](/v2/images/concepts/constraints_types.png)

<Note>
  The constraint value is represented as a string in transit and in storage, however it's coerced into the appropriate type for evaluation.
</Note>
...
![Default Rule](/v2/images/concepts/rules_default.png)
