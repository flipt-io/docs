...
See the [Authentication: Overview](/v2/authentication/overview) documentation for more details on Flipt's API authentication handling.
...
Further explanation for using this method can be found in the [Authentication: Static Token](/v2/authentication/methods#static-token) documentation.
...
!["OIDC Login"](/v2/images/configuration/oidc_login.png)
...
!["GitHub Login"](/v2/images/guides/login-with-github/login-with-github.png)
