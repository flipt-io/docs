...
Flipt v2 is a single binary that can be run on any Linux or macOS (arm64) host. You can install and try out Flipt v2 in a few different ways:
...
flipt:
  config:
    ...
    storage:
      type: git
      git:
        repository: https://github.com/your-org/flags-repo.git
        ref: main
    analytics:
      storage:
        clickhouse:
