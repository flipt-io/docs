...
<Note>
  ...
  This ensures v2-specific configurations and compatibility. The `--devel` flag
...
<Note>
  This example showcases common v2 configuration options including CORS, UI customization, and observability settings. For production use with Git-backed storage, see the [Git Storage guide](/v2/guides/operations/environments/git-sync).
</Note>
