...
<Warning>
  Flipt v2 is currently in beta and is not recommended for production use.
</Warning>
...
Flipt v2 introduces the concept of environments, which are an additional layer above Flipt v1's concept of [Namespaces](/v1/concepts#namespace).
