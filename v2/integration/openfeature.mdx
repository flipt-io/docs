...
<Note>
  While Flipt v2 is backward compatible with Flipt v1, the OpenFeature providers have not yet be updated to support the new `environments` concept in Flipt v2.
