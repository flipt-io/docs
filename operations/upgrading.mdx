...
We design our migrations to be forward compatible with older Flipt server versions, so it is safe for you to keep running Flipt while the migrations are run and after they have finished.
