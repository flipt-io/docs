...
<Tip>
  **Quick Configuration**: If you want to quickly set up Flipt with Git storage and SCM integration, you can use the interactive [`flipt quickstart`](/v2/cli/commands/quickstart) command. The wizard will guide you through configuring your Git repository and authentication.
</Tip>
