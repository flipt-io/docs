...
<Note>
  The `--skip-schema-validation` flag is safe to use and does not affect
  functionality. Track schema updates in
  [flipt-io/helm-charts](https://github.com/flipt-io/helm-charts).
</Note>
