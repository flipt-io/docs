...
| analytics.storage.prometheus.sigv4.region             | AWS region for SigV4 authentication (required for Amazon Managed Prometheus) |    | v2.0.0 |
| analytics.storage.prometheus.sigv4.access_key         | AWS access key ID for SigV4 authentication                              |         | v2.0.0 |
| analytics.storage.prometheus.sigv4.secret_key         | AWS secret access key for SigV4 authentication                          |         | v2.0.0 |
| analytics.storage.prometheus.sigv4.profile            | AWS credentials profile to use for SigV4 authentication                 |         | v2.0.0 |
| analytics.storage.prometheus.sigv4.role_arn           | AWS IAM role ARN to assume for SigV4 authentication                     |         | v2.0.0 |
