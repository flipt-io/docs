...
| Property                           | Description                                                     | Default | Since  |
| ---------------------------------- | --------------------------------------------------------------- | ------- | ------ |
| secrets.providers.aws.endpoint_url | Custom endpoint URL (for LocalStack or AWS-compatible services) |         | v2.0.0 |

#### Secrets Provider: GCP Secret Manager

| Property                          | Description                                   | Default | Since  |
| --------------------------------- | --------------------------------------------- | ------- | ------ |
| secrets.providers.gcp.project     | GCP project ID                                |         | v2.0.0 |
| secrets.providers.gcp.location    | GCP region for regional secrets               |         | v2.0.0 |
| secrets.providers.gcp.credentials | Path to service account credentials JSON file |         | v2.0.0 |

#### Secrets Provider: Azure Key Vault

| Property                          | Description                                                     | Default | Since  |
| --------------------------------- | --------------------------------------------------------------- | ------- | ------ |
| secrets.providers.azure.vault_url | Azure Key Vault URL (e.g., `https://my-vault.vault.azure.net/`) |         | v2.0.0 |
