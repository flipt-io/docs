...
This command builds a new bundle containing feature files identified via Flipt's feature index (see: [Locating flag state](/v1/configuration/storage#locating-flag-state)).
