...
<div className="block dark:hidden">
  ![Flipt Architecture](/v1/images/architecture/flipt_light.svg)
</div>

<div className="hidden dark:block">
  ![Flipt Architecture](/v1/images/architecture/flipt_dark.svg)
</div>
</Frame>
...
[Getting Started](/v1/introduction) documentation.
...
See our [Storage](/v1/configuration/storage) documentation for more information on all of the available storage backends.
