...
More information on how to use Flipt is noted in the [Getting Started](/v1/introduction) documentation.
...
![Namespaces Settings](/v1/images/concepts/namespaces_production.png)
...
![Namespaces Settings](/v1/images/concepts/namespaces_default.png)

Namespaces can be managed within the `Settings` section of the Flipt UI:

![Namespaces Settings](/v1/images/concepts/settings_namespaces.png)
...
![Flags Example](/v1/images/concepts/flags.png)
...
![Variant Flags Example](/v1/images/concepts/flags_variants.png)
...
![Boolean Flags Example](/v1/images/concepts/flags_boolean.png)
...
![Segments Example](/v1/images/concepts/segments.png)
...
![Constraints Example](/v1/images/concepts/constraints.png)
...
![Constraint Types](/v1/images/concepts/constraints_types.png)
...
![Rules Example](/v1/images/concepts/rules.png)
...
<Info>Default Rules are available since v1.47.0 of Flipt.</Info>
...
![Default Rule Example](/v1/images/concepts/default_rule.png)
...
![Distributions Example](/v1/images/concepts/distributions.png)
...
![Rollouts Example](/v1/images/concepts/rollouts.png)
...
![Evaluation Example](/v1/images/concepts/evaluation.png)
