...
<img className="block dark:hidden" src="/images/cloud/architecture/handshake-light.svg" />
<img className="hidden dark:block" src="/images/cloud/architecture/handshake-dark.svg" />
