...
<img className="block dark:hidden" src="/images/cloud/architecture/common-infrastructure-light.svg" />
<img className="hidden dark:block" src="/images/cloud/architecture/common-infrastructure-dark.svg" />
...
<img className="block dark:hidden" src="/images/cloud/architecture/architecture-overview-light.svg" />
<img className="hidden dark:block" src="/images/cloud/architecture/architecture-overview-dark.svg" />
