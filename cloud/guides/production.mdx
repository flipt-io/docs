...
4. Deployed Flipt instances in your infrastructure. If you don't have Flipt instances yet, [deploy Flipt Open Source](/v1/installation/overview).
...
<Steps>
  <Step title="Install the SDK">
    Choose the SDK that matches your application's language and install it. All client-side SDKs are documented [here](/v1/integration/client).
  </Step>
...
<Steps>
  <Step title="Configure the Flipt instances">
    ...
    As described in the Flipt Open Source [storage documentation](/v1/configuration/storage#git), you can configure the Flipt instances to use the Git repository data source.
  ...
  <Step title="Install the SDK">
    Choose the SDK that matches your application's language and install it. All server-side SDKs are documented [here](/v1/integration/server).

    <Note>
      You can also use any of our [OpenFeature SDKs](/v1/integration/openfeature) or [OpenFeature Remote Evaluation Protocol implementations](/v1/integration/openfeature#remote-evaluation-protocol) to evaluate feature flags within your infrastructure.
    </Note>
  </Step>
