...
<Note>
  If you don't specify a path, your feature flags and configurations will be
  stored in the root of your repository.
</Note>
...
<Tip>
  Each namespace within Flipt Managed Cloud is represented as an additional
...
See the [Moving to Production](/cloud/guides/production) guide for more information on how to manage users, permissions, and how to connect your code to your Flipt Managed Cloud environment for evaluation.
