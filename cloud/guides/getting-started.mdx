...
![Flipt UI](/cloud/images/guides/getting-started/flipt-ui.png)
  ...
  <Step title="Create a Feature Flag">
    ...
    See the [Getting Started](/v1/introduction#create-a-flag) guide in Open Source for more information on how to create a feature flag.
...
<Tip>
  Each namespace within Flipt Cloud is represented as an additional subdirectory
  in your repository.
</Tip>
...
See the [Moving to Production](/cloud/guides/production) guide for more information on how to manage users, permissions, and how to connect your code to your Flipt Cloud environment for evaluation.
