...
<Info>Flipt Hybrid Cloud is in Active Beta. We are currently onboarding organizations one by one. If you are interested in joining the beta, please [sign up here](https://1ld82idjvlr.typeform.com/to/s7YfGviE).</Info>
...
<Check>Note that you didn't have to mess with DNS or firewall settings to enable the connection between Flipt and your instance. Flipt Hybrid Cloud takes care of all the networking for you.</Check>
...
<Note>
The connection between your local instance and Flipt Hybrid Cloud is temporary and will expire after about 24 hours.
</Note>
