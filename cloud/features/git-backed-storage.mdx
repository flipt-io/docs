...
![Git-Backed Storage](/images/cloud/features/git-backed-storage/git-backed-storage.png)
...
<Note>
For more info on the benefits of using Git-backed storage, see the [Benefits](/cloud/benefits#gitops-and-clickops-friendly) page.
</Note>
...
![Flipt UI](/images/cloud/features/git-backed-storage/flipt-ui.png)
