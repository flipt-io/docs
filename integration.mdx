...
The latest version of the REST API is fully documented using [OpenAPI v3 specification](https://github.com/flipt-io/flipt-openapi) as well as the above [API Reference](/reference/flags/list-flags).
