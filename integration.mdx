...
This means that your application can use the Flipt GRPC client if it's written
...
<Warning>
  These libraries aren't maintained by the Flipt team and may not be up to date
