...
<Tip>
  ...
  See the [CLI](/v1/cli) documentation for more information.
</Tip>
...
These environment variables are used by the underlying object storage client libraries to authenticate with the object storage service and are the same values used in our [object storage configuration](/v1/configuration/storage#object).
...
<Note>
  ...
  running with Docker as described in the [Docker](/v1/installation/docker)
  documentation.
</Note>
...
| meta.telemetry_enabled        | Enable anonymous telemetry data (see [Telemetry](/v1/configuration/telemetry)) | true                | v1.8.0  |
...
See the [Experimental](/v1/configuration/experimental) documentation for more information on the current experimental features and how to enable them.
