...
![Create Role](/v1/images/guides/rbac-with-keycloak/create-keycloak-role.png)
...
![Assign Role](/v1/images/guides/rbac-with-keycloak/assign-keycloak-role.png)
...
![Map Client Scopes](/v1/images/guides/rbac-with-keycloak/map-client-scopes.png)
...
![Customize Role Mapper](/v1/images/guides/rbac-with-keycloak/customize-role-mapper.png)
...
![Unauthorized Access](/v1/images/guides/rbac-with-keycloak/unauthorized.png)
