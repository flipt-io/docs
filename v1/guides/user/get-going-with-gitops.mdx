...
<Info>
  ...
  Backends](/v1/configuration/storage#declarative) to learn more about configuring
...
<Info>
  Head to [Concepts: Bucketing](/v1/concepts#bucketing) to learn how this mechanism
