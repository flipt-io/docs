...
To deploy Flipt to Kubernetes, use our Helm chart as described in our [Kubernetes](/v1/installation/kubernetes) documentation.
...
See our [Kubernetes Authentication](/v1/authentication/methods#kubernetes) documentation for more information on how to configure Kubernetes service account authentication.
...
See the [Metrics Configuration](/v1/configuration/observability#metrics) documentation for more information on the metrics exposed by Flipt and how to configure them.
...
For more information on the logs exposed by Flipt and how to configure them, see the [Logging Configuration](/v1/configuration/observability#logging) documentation.
...
For more information on the tracing exposed by Flipt and how to configure it, see the [Tracing Configuration](/v1/configuration/observability#tracing) documentation.
...
Our [Declarative Storage](/v1/configuration/storage#declarative) also allows you to easily migrate between storage backends. For example, you can start with a local SQLite database and migrate to a cloud object storage backend as your usage grows.
...
See our [Authentication](/v1/authentication) documentation for more information on the authentication methods supported by Flipt.
...
See our [Architecture](/v1/operations/architecture) and [Deployment](/v1/operations/deployment) documentation for more information on how to deploy Flipt for performance and scalability.
