...
If you are a [Flipt Cloud](/v1/cloud/overview) user, you can enable `streaming` mode, which will make the SDK subscribe to changes on the Flipt server and update the state of the flags accordingly in real-time.

<Card href="/v1/cloud/overview" title="Flipt Cloud" icon="cloud">
