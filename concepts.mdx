...
Namespaces are the recommended way to organize all of the resources such as Flags, Segments, Rules, etc within Flipt as of [v1.20.0](https://github.com/flipt-io/flipt/releases/tag/v1.20).

Namespaces allow you to seperate all data within Flipt for use in different environments such as: Development, Staging, Production, etc.

![Namespaces Settings](/images/concepts/namespaces/production.png)

Another common use-case of Namespaces is to seperate Flipt data by internal team or organization.
