...
<Tip>
  This is your opportunity to validate the change before exposing it to a wider
  audience. Perhaps the algorithm is incorrect, maybe the order has reversed or
  has become unstable for some entries. You can fix those changes now before
