...
Alongside the support for generic OIDC login, Flipt has launched support for login with GitHub in version [v1.26.0](https://github.com/flipt-io/flipt/tree/v1.26.0), through their OAuth2.0 flow. This guide will serve as a walk-through on how to set this flow up for users of Flipt in your organization.
...
<Note>
We're using `ngrok` here for illustration purposes. In a production setting, you would use whichever publically accessible domain name you have configured for your Flipt deployment. These values can always be changed later after the creation of the application.
</Note>
