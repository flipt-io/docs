...
3. Configure the application with the Flipt Docker image. Use the image location `ghcr.io/flipt-io/flipt:latest`.
3. Configure the application with the Flipt Docker image.
