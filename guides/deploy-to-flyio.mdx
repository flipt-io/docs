...
4. Configure the application with the Flipt Docker image. Use the image location `ghcr.io/flipt-io/flipt:latest`.
5. Configure the application with the Flipt Docker image.
