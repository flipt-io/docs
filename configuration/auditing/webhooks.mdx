...
<Note>As of [v1.39.0](https://github.com/flipt-io/flipt/releases/tag/v1.39.0), the Go template contains a `toJson` utility method that will transform an input into JSON if it fits the structure.</Note>
