...
<Tip>
  Read our [Sending Audit Events to
  Datadog](/guides/operation/auditing/log-webhooks-datadog) guide for a more
  in-depth walk-through setting up a webhook sink with templating.
</Tip>
