...
| log.keys.time          | Structured logging key used when outputting log timestamp                               | T                   | v1.19.0 |
| log.keys.level         | Structured logging key used when outputting log level                                   | L                   | v1.19.0 |
| log.keys.message       | Structured logging key used when outputting log message                                 | M                   | v1.19.0 |
