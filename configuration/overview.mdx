...
| storage.git.backend                                     | The backend to use for git repository storage (options: memory, local) | memory  | v1.43.0 |
...
Example: To enable the experimental cloud feature, add the following to your configuration file:
