...
| authentication.session.domain                                     | Public domain on which this Flipt instance is hosted          |         | v1.17.0 |
...
| authentication.methods.oidc.cleanup.grace_period                  | How expired a token can become before it is deleteable        | 30m     | v1.17.0 |
...
<Tip>
If you have `openssl` installed you can generate one with:
...
Further explanation for using this method can be found in the [Authentication: Token](/authentication#token) documentation section of this site.
